...
namespace gazebo
{
   struct AviaRotateInfo
   {
      ...
      double azimuth;
      double zenith;
      // Unit direction in the sensor frame. The scan pattern is immutable,
      // so calculate its trigonometry once during plugin initialization.
   ...
   private:
      ...
      double scanPatternPeriodTicks = 0.0;
      double scanPeriodSeconds = 0.1;
      common::Time lastScanSimTime;
